...
const setPathprojectApplication = (req,res,next) =>{ 
    try{
        req.folderPath = `/Project/${req.params.projectId}/File`;
        next();
    }catch(error){
        throw new ApiError(error, 403);
    }
...
module.exports = {upload, setPathprojectApplication,setPathFilledApplication, setPathAck,setPathPublicationApplication};